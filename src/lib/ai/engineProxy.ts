 ...
 * without a server runtime. A worker (Cloudflare Workers, Netlify function,
 * …) is a thin HTTP shell over these functions — see README → AI answers.
 *
...
/** Environment shape a worker passes in. */
