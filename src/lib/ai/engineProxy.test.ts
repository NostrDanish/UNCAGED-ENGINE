/**
 * Engine-AI proxy logic tests — the security-critical invariants of the
 * worker shell, verified without a server runtime.
...
/* ─── Provider error sanitation (no-leak) ─── */
...
describe('applyAdminAction', () => {
  it('set writes a full config; clear deletes; set-enabled toggles', () => {
