 ...
 * Ported from the Dsearch-family core; toEngineQuery tests are dropped
 * (this app has no external engines to translate for).
 */
import { describe, it, expect } from 'vitest';

import { parseQuery, textOnly, type QueryNode } from '@/lib/queryParser';
